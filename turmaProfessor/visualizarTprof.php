    ...
    <div class="tudo">
        <div class="conteiner">
            ...
            $camp = $_POST['campo'];
                ...
                $comando ="SELECT turmaprofessor.codigo as codigo, turma.nome as turma, professor.nome as professor
                          FROM turmaprofessor
                          INNER JOIN turma ON turmaprofessor.codTurma = turma.codigo
                          INNER JOIN professor ON turmaprofessor.codProfessor = professor.codigo
                          WHERE `$camp` LIKE '%$ref%';";
                ...
                while($linha = $view-> fetch_assoc()){
					...
					echo"<td><form method='POST' action='alterarTprof.php'>
								<input type='hidden' name='codigo' value='".$linha["codigo"]."'/><br/>
								<input type='submit' value='Alterar' />
							</form></td>";
					echo"<td><form method='POST' action='deletarTprof.php'>
								<input type='hidden' name='codigo' value='".$linha["codigo"]."'/><br/>
