					...
					<div class="nome">
						...
						<?php
							...
							if($codigo == ''){
								...
								echo ("	Codigo: <br/><input type='text' name='codigo' value='".$linha["codigo"]."'/><br/><br/>");
								...
								echo ("	Data de Nascimento: <br/> <input type='text' name='data_nasc' value='".$linha["data_nasc"]."'/><br/><br/>");
