        ...
        <div class="conteiner">
            ...
            $camp = $_POST['campo'];
                ...
                $comando ="SELECT turmaaluno.codigo as codigo, turma.nome as turma, aluno.nome as aluno
                        FROM turmaaluno
                        INNER JOIN turma ON turmaaluno.codTurma = turma.codigo
                        INNER JOIN aluno ON turmaaluno.codAluno = aluno.ra
                        WHERE `$camp` LIKE '%$ref%';";
                ...
                while($linha = $view-> fetch_assoc()){
					...
					echo"<td><form method='POST' action='alterarTaluno.php'>
								<input type='hidden' name='codigo' value='".$linha["codigo"]."'/><br/>
								<input type='submit' value='Alterar' />
							</form></td>";
					echo"<td><form method='POST' action='deletarTaluno.php'>
								<input type='hidden' name='codigo' value='".$linha["codigo"]."'/><br/>
